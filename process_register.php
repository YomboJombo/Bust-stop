...
if ($enter_password == $confirm_password)
{
	...
	// Customer table
	$stmt = $connect->prepare("insert into customer (user_name, FirstName, LastName, dob, Address1, Address2, PostCode, EmailAddress, PhoneNumber, roles, Password) 
								values (:a, :b, :c, :d, :e, :f, :g, :h, :i, '$roles', :j)");
