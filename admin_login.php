<?php include("./header.php"); ?>
    ...
    <div class="container-fluid">
        <h6 style="text-align: center; color: black; font-style: italic;">Admin log in</h6>
        ...
        <form action="process_admin_login.php" method="POST">
            <fieldset class="form-group">
                ...
                <div class="form-group">
                    <label class="form-control-label" for="admin_fourth_name" style="font-weight: bold;">Enter your Name:</label>
                    <input class="form-control" style="width: 50%;" type="text" id="admin_fourth_name" name="admin_fourth_name" placeholder="Enter user name or email" required>
                </div> 
                <div class="form-group">
